...
import {createPosts,viewPosts,createComments, viewComments, createRate, viewRate, Count, noRate,noComments, findPosts, findUserPosts } from "../controllers/posts.js";
...
route.post("/finduserposts/", findUserPosts);
